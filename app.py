...
def parse_wide_csv(raw: str) -> pd.DataFrame:
    ...
    try:
        ...
        # Normalise MPRN — ESB wide exports sometimes store it as scientific notation string
    ...
    with col1:
        if is_unfinished and proj_factor > 1.0:
            ...
            <div class="metric-container">
                ...
                <div class="metric-label">Estimated Month-End Usage (kWh)</div>
            ...
            <div class="metric-container">
                ...
                <div class="metric-label">Actual Usage To Date (kWh)</div>
